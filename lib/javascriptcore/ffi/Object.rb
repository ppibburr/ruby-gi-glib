...
module JavaScriptCore
  module Lib
    class Object < JavaScriptCore::BaseObject
      ...
      def self.make(ctx,jsClass,data)
        JavaScriptCore::Lib.JSObjectMake(ctx,jsClass,data)
      end
      ...
      def self.make_function_with_callback(ctx,name,callAsFunction)
        JavaScriptCore::Lib.JSObjectMakeFunctionWithCallback(ctx,name,callAsFunction)
      end
      ...
      def self.make_constructor(ctx,jsClass,callAsConstructor)
        JavaScriptCore::Lib.JSObjectMakeConstructor(ctx,jsClass,callAsConstructor)
      end
      ...
      def self.make_array(ctx,argumentCount,arguments,exception)
        JavaScriptCore::Lib.JSObjectMakeArray(ctx,argumentCount,arguments,exception)
      end
      ...
      def self.make_function(ctx,name,parameterCount,parameterNames,body,sourceURL,startingLineNumber,exception)
        JavaScriptCore::Lib.JSObjectMakeFunction(ctx,name,parameterCount,parameterNames,body,sourceURL,startingLineNumber,exception)
      end
      ...
      def get_prototype(ctx,object)
        JavaScriptCore::Lib.JSObjectGetPrototype(ctx,object)
      end
      ...
      def set_prototype(ctx,object,value)
        JavaScriptCore::Lib.JSObjectSetPrototype(ctx,object,value)
      end
      ...
      def has_property(ctx,object,propertyName)
        JavaScriptCore::Lib.JSObjectHasProperty(ctx,object,propertyName)
      end
      ...
      def get_property(ctx,object,propertyName,exception)
        JavaScriptCore::Lib.JSObjectGetProperty(ctx,object,propertyName,exception)
      end
      ...
      def set_property(ctx,object,propertyName,value,attributes,exception)
        JavaScriptCore::Lib.JSObjectSetProperty(ctx,object,propertyName,value,attributes,exception)
      end
      ...
      def delete_property(ctx,object,propertyName,exception)
        JavaScriptCore::Lib.JSObjectDeleteProperty(ctx,object,propertyName,exception)
      end
      ...
      def get_property_at_index(ctx,object,propertyIndex,exception)
        JavaScriptCore::Lib.JSObjectGetPropertyAtIndex(ctx,object,propertyIndex,exception)
      end
      ...
      def set_property_at_index(ctx,object,propertyIndex,value,exception)
        JavaScriptCore::Lib.JSObjectSetPropertyAtIndex(ctx,object,propertyIndex,value,exception)
      end
      ...
      def get_private(object)
        JavaScriptCore::Lib.JSObjectGetPrivate(object)
      end
      ...
      def set_private(object,data)
        JavaScriptCore::Lib.JSObjectSetPrivate(object,data)
      end
      ...
      def is_function(ctx,object)
        JavaScriptCore::Lib.JSObjectIsFunction(ctx,object)
      end
      ...
      def call_as_function(ctx,object,thisObject,argumentCount,arguments,exception)
        JavaScriptCore::Lib.JSObjectCallAsFunction(ctx,object,thisObject,argumentCount,arguments,exception)
      end
      ...
      def is_constructor(ctx,object)
        JavaScriptCore::Lib.JSObjectIsConstructor(ctx,object)
      end
      ...
      def call_as_constructor(ctx,object,argumentCount,arguments,exception)
        JavaScriptCore::Lib.JSObjectCallAsConstructor(ctx,object,argumentCount,arguments,exception)
      end
      ...
      def copy_property_names(ctx,object)
        JavaScriptCore::Lib.JSObjectCopyPropertyNames(ctx,object)
      end
    end
  end
end
